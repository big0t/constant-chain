...
func (tx *Tx) GetSenderPaymentAddress() (*privacy.PaymentAddress, error) {
	if tx.IsPrivacy() {
		return nil, errors.New("Can not get sender payment address of privacy transaction")
	}
	return tx.GetSenderAddress(), nil
}
